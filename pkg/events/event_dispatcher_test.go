...
func (h *TestEventHander) Handle(event EventInterface) {
...
func (suite *EventDispatcherTestSuite) SetupTest() {
	...
	suite.handler = TestEventHander{ID: 1}
	suite.handler2 = TestEventHander{ID: 2}
	suite.handler3 = TestEventHander{ID: 3}
